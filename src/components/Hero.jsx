  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>
            Hello, I'm <span className="text-[#915eff]">Deiver!</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I create and develop modern web applications that solve real
            problems
            {/* <br /> */}
          </p>
        </div>
      ...
      <div className="absoulte xs:bottom-10 bottom-32 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl border-4 border-secondary flex justofy-center items-start p-2">
            <motion.dev
              animate={{ y: [0, 24, 0] }}
              transition={{
                duration: 1.75,
